...
const INITIAL_DATA = [
    {
        ...
        clientData: { name: "COMPAÑIA DOMINICANA DE TELEFONOS S.A.", rnc: "101010101", address: "Av. John F. Kennedy 27, Santo Domingo", phone: "809-220-0000", email: "facturacion@claro.com.do" },
