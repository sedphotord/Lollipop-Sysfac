...
const INITIAL_DATA = [
    { id: "AJ-001", fecha: "24 Oct 2024", almacen: "Principal", motivo: "Mercanc├¡a Da├▒ada", tipo: "disminucion", itemsCount: 4, monto_impacto: 12500, status: "aplicado" },
    { id: "AJ-002", fecha: "15 Oct 2024", almacen: "Secundario", motivo: "Conteo F├¡sico (Sobrante)", tipo: "incremento", itemsCount: 2, monto_impacto: 4500, status: "aplicado" },
    ...
    { id: "AJ-004", fecha: "30 Sep 2024", almacen: "Principal", motivo: "Mercanc├¡a Vencida", tipo: "disminucion", itemsCount: 12, monto_impacto: 45000, status: "aplicado" },
        ...
        <div className="space-y-6 animate-in fade-in slide-in-from-bottom-3 duration-500">
            <div className="flex items-center justify-between gap-4">
                <div>
                    ...
                    <p className="text-muted-foreground mt-1 text-sm">Registra cambios de stock que no provengan de ventas o compras (mermas, da├▒o, uso interno).</p>
                </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-4 gap-4">
                {[
                    ...
                    { label: "P├®rdida/Mermas (RD$)", value: `-${impactedValue.toLocaleString(undefined, { minimumFractionDigits: 0 })}`, icon: PackageMinus, color: "text-rose-600 bg-rose-500/10" },
                    ...
                    <div className="flex gap-3 mb-4">
                        ...
                        <Select defaultValue="todos">
                            ...
                            <SelectContent>
                                ...
                                <SelectItem value="disminucion">Mermas (Disminuci├│n)</SelectItem>
                            </SelectContent>
                        </Select>
                    ...
                    <div className="bg-background rounded-2xl shadow-2xl w-full max-w-md overflow-hidden relative" onClick={e => e.stopPropagation()}>
                        ...
                        <div className="p-8 space-y-6">
                            ...
                            <div className="space-y-4">
                                ...
                                <div className="flex justify-between items-center py-2 border-b border-border/40">
                                    <span className="text-sm text-muted-foreground">Almac├®n</span>
                                ...
                                <div className="flex justify-between items-center py-2 border-b border-border/40">
                                    ...
                                    <span className="text-sm font-bold text-primary">{selectedAjuste.itemsCount} ├¡tems</span>
                                </div>
                                <div className="flex justify-between items-center py-2 border-b border-border/40">
