...
import { Eye, EyeOff, LogIn, ArrowLeft, Receipt, Building2, ShieldCheck, BarChart3 } from "lucide-react";
                ...
                <div className="relative flex flex-col h-full p-10 z-10">
                    ...
                    <div className="py-12">
                        ...
                        <h1 className="text-4xl xl:text-5xl font-black text-white leading-[1.15] mb-5">
                            El software de<br />
                            <span className="bg-gradient-to-r from-blue-400 to-sky-300 bg-clip-text text-transparent">facturación</span>{" "}
                    ...
                    <div className="w-full max-w-sm">
                        ...
                        <form onSubmit={handleSubmit} className="space-y-5">
                            ...
                            <div className="space-y-1.5">
                                ...
                                <input
                                    ...
                                    required
                                    className="w-full border border-border rounded-xl px-4 py-3 text-sm bg-background outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-500/20 transition-all"
                                />
                            </div>
                            ...
                            <div className="space-y-1.5">
                                ...
                                <div className="relative">
                                    <input
                                        ...
                                        required
                                        className="w-full border border-border rounded-xl px-4 py-3 pr-12 text-sm bg-background outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-500/20 transition-all"
                                    />
                        ...
                        <details className="mt-6 group">
                            ...
                            <div className="mt-3 p-3 bg-muted/40 rounded-xl border border-border/60 space-y-1.5">
                                {[
                                    { email: "juan@lollipop.do", password: "Lollipop2025!", role: "Contador · 3 empresas" },
                                    { email: "carlos@techsolutionsrd.com", password: "TechRD2025!", role: "Propietario · TechSolutions" },
                                    { email: "pedro@buensabor.do", password: "BuenSabor25!", role: "Propietario · Cafetería" },
                                    { email: "maria@buensabor.do", password: "Cajera2025!", role: "Cajera · Solo POS" },
                                ].map(u => (
                                    <button key={u.email} type="button"
                                        ...
                                        <span className="font-mono text-[10px] text-blue-500 bg-blue-50 dark:bg-blue-500/10 px-2 py-0.5 rounded-md truncate max-w-[100px]">{u.password}</span>
                                    </button>
                                ))}
                            </div>
                        </details>
