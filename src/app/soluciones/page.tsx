        ...
        <div className="flex flex-col min-h-screen">
            ...
            <main className="flex-1">
                ...
                <section className="py-20 md:py-28 relative overflow-hidden bg-[#faf9ff] dark:bg-neutral-950">
                    <div className="absolute top-20 left-1/3 w-96 h-96 bg-blue-400/15 rounded-full blur-[120px] pointer-events-none" />
                    <div className="absolute bottom-10 right-1/4 w-72 h-72 bg-sky-400/10 rounded-full blur-[100px] pointer-events-none" />
                    <div className="container mx-auto px-4 relative z-10 text-center max-w-3xl">
                        <p className="text-xs font-bold text-blue-400 tracking-[0.2em] uppercase mb-3">Soluciones</p>
                        <h1 className="text-4xl md:text-5xl font-black tracking-tight mb-4">
                            Una solucion para cada{" "}
                            <span className="bg-gradient-to-r from-blue-600 to-sky-500 bg-clip-text text-transparent">necesidad</span>
                        </h1>
                            ...
                            {SOLUCIONES.map((sol, i) => (
                                <div key={sol.slug} className={`grid grid-cols-1 lg:grid-cols-2 gap-8 items-center ${i % 2 === 1 ? "lg:flex-row-reverse" : ""}`}>
                                    <div className={i % 2 === 1 ? "lg:order-2" : ""}>
                                        <div className="flex items-center gap-3 mb-4">
                                            ...
                                            <div>
                                                <div className="flex items-center gap-2">
                                                    ...
                                                    {sol.badge && <span className="px-2 py-0.5 bg-blue-100 text-blue-700 rounded-full text-[10px] font-bold">{sol.badge}</span>}
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <Link href="/register" className="inline-flex items-center gap-2 text-sm font-bold text-blue-600 hover:text-blue-700 transition-colors">
                                    ...
                                    <div className={`${i % 2 === 1 ? "lg:order-1" : ""}`}>
                                        <div className="relative">
                                            ...
                                            <div className="relative bg-white dark:bg-neutral-900 rounded-2xl border border-blue-200/50 dark:border-blue-800/30 shadow-xl shadow-blue-500/5 p-8 flex items-center justify-center aspect-[4/3]">
                ...
                {/* CTA */}
                <section className="py-16 md:py-24 bg-gradient-to-r from-blue-600 to-sky-500 relative overflow-hidden">
                    ...
                    <div className="container mx-auto px-4 relative z-10 text-center text-white">
                        ...
                        <Link href="/register">
                            <button className="px-8 py-4 bg-white text-blue-700 font-bold rounded-full shadow-xl hover:shadow-2xl transition-shadow text-base">
